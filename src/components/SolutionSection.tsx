      ...
      <div className="container mx-auto px-4 relative z-10" ref={ref}>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mt-16">
          <div className={`md:w-1/2 space-y-6 transition-all duration-1000 delay-300 ${inView ? 'opacity-100' : 'opacity-0 -translate-x-12'}`}>
            <h3 className="text-solox-blue font-audiowide text-3xl mb-6">IN SPACE</h3>
            ...
            <div className="space-y-8">
              <div className="glass-card p-6 hover:border-solox-blue transition-colors">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-white mb-2">Water Ice</h4>
                    <p className="text-gray-300 leading-relaxed">
                      Essential for life support, fuel production, and sustainable exploration on the Moon and Mars.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-card p-6 hover:border-solox-blue transition-colors">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      Crucial for constructing infrastructure and enabling In-Situ Resource Utilization (ISRU).
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className={`md:w-1/2 transition-all duration-1000 ${inView ? 'opacity-100' : 'opacity-0 translate-x-12'}`}>
            <div className="relative rounded-lg overflow-hidden">
              ...
              <img 
                src="https://www.soloxspace.com/imagenes/water%20ice%20solox.jpg" 
