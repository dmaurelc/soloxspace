  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10" ref={ref}>
        ...
        <div
          className={`max-w-4xl mx-auto glass-card p-8 md:p-12 mt-12 transition-all duration-1000 delay-300 ${
            inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
          }`}
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-audiowide mb-6 text-solox-blue">
                Get in Touch
              </h3>
              <p className="text-gray-300 mb-8 leading-relaxed font-inter">
                Interested in learning more about our technologies or potential
                collaborations? Reach out to our team to discuss how SOLOX Space
                can help advance your projects.
              </p>

              <div className="flex items-center mb-6">
                <Mail size={20} className="text-solox-blue mr-4" />
                <a
                  href="mailto:info@soloxspace.com"
                  className="text-white hover:text-solox-blue transition-colors font-inter"
                >
                  info@soloxspace.com
                </a>
              </div>
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <input
                  type="hidden"
                  name="access_key"
                  value="43308279-7b3c-4767-a085-2cd10910605a"
                />
                <input
                  type="hidden"
                  name="subject"
                  value="Nuevo mensaje desde Solox Space"
                />
                <input
                  type="hidden"
                  name="from_name"
                  value="Solox Space Website"
                />
                <input
                  type="checkbox"
                  name="botcheck"
                ...
                <button
                  type="submit"
                  className="solox-button group w-full flex justify-center items-center hover:text-solox-white"
